...
carousels:
  - images: 
    - image: /assets/img/left-4-b4it-slider/img1.png
      caption: Shop with 3 random buffs
    - image: /assets/img/left-4-b4it-slider/img2.png
      caption: Levels get darker the deeper you go
    - image: /assets/img/left-4-b4it-slider/img3.png
      caption: Death screen
    - image: /assets/img/left-4-b4it-slider/img4.png
      caption: Each level introduces new sea zombie enemy
---
